...
$config = ['tables' => [
    'cmis:meta_types'            => $cmisMetaTypes,
    'cmis:meta_properties'       => $cmisMetaProperties,
    'cmis:meta_types_properties' => $cmisMetaTypesProperties,
    'cmis_object'                => $cmisObject,
    'cmis_document'              => $cmisDocument,
    'cmis_policy'                => $cmisPolicy,
    'cmis_relationship'          => $cmisRelationship,
    'cmis_folder'                => $cmisFolder,
    'cmis:repository_info'       => $cmisRepositoryInfo,
]];
$adapter->query(
    $sql->getDdl()->createTable($cmisMetaTypes)
...
$adapter->query(
    $sql->getDdl()->createTable($cmisMetaProperties)
...
$adapter->query(
    $sql->getDdl()->createTable($cmisMetaTypesProperties)
        ->addColumn(new Column\Varchar('propertyId',     255, false))
...
$adapter->query(
    $sql->getDdl()->createTable($cmisObject)
...
$adapter->query(
    $sql->getDdl()->createTable($cmisDocument)
...
$adapter->query(
    $sql->getDdl()->createTable($cmisFolder)
        ->addColumn(new Column\Integer ('cmis_objectId', false))
...
$adapter->query(
    $sql->getDdl()->createTable($cmisRelationship)
        ->addColumn(new Column\Integer ('cmis_objectId', false))
...
$adapter->query(
    $sql->getDdl()->createTable($cmisPolicy)
        ->addColumn(new Column\Integer ('cmis_objectId', false))
...
$adapter->query(
    $sql->getDdl()->createTable($cmisRepositoryInfo)
